...
import DeadClicks from './clarity/dead-click-pencil.gif';

<img src={DeadClicks} alt="Dead Clicks" />

#### Larget Content Paint
...
CookieYes Let's application to Generate a fully customizable cookie banner, record user consent and manage all your cookie compliance needs in one place.

The way CookieYes works is that it scans your website for cookies and automatically generates a cookie banner that informs users about the cookies being used.
...
import GTMSetup from './gtm/setup.gif';

<img src={GTMSetup} alt="Google tag manager Setup" />
