...
description: why-did-you-render monkey patches React to notify you about potentially avoidable re-renders
...
On reload of your application you should see the logs coming in the console.
