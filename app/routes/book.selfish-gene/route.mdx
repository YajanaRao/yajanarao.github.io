...
date: "2024-02-21"
description: "The Selfish Gene is a seminal work in evolutionary biology written by Richard Dawkins, first published in 1976. It presents the gene-centered view of evolution, which suggests that genes, rather than organisms or species, are the fundamental units of selection. In other words, genes are the entities that are replicated and passed on from generation to generation through the process of natural selection."
---
