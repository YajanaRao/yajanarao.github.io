...
import SimpleConditions from './simple-conditions.png';

<img src={SimpleConditions} alt="simple conditions" />
...
import NestedConditions from './nested-conditions.png';

<img src={NestedConditions} alt="nested conditions" />
