...
import PassingArguments from './passing-arguments.png';

<img src={PassingArguments} alt="passing arguments to function" />
...
import ReturnStatement from './return-statement.png';

<img src={ReturnStatement} alt="return statement from function" />
...
import HowFunctionsWork from './how-functions-work.png';

<img src={HowFunctionsWork} alt="how functions work" />
