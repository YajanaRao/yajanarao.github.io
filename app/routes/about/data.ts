...
export const projects = [
  ...
  },
  {
    ...
    source: [
      ...
      },
      {
        ...
        text: "github",
        type: "github",
        link: "https://github.com/YajanaRao/react-track-player",
      },
    ],
    tags: [
      {
  ...
  {
    key: "browser-recorder",
    title: "Browser Recorder",
    link: "https://github.com/YajanaRao/BrowserRecorder",
    video: "https://www.youtube.com/embed/1_aKCXTcGMI?si=kTmzzZA8Nqc7WXNN",
    description:
      " A simple tool to convert web animations into high quality videos using python, selenium and opencv.",
    tags: [
      { key: "Python", text: "Python" },
      { key: "Selenium", text: "Selenium" },
      { key: "OpenCV", text: "OpenCV" },
    ],
    source: [
      {
        key: "github",
