...
It might be your IDE or code editor, Please don't change them often. Code editors or IDE's has there own keybindings, themes and functionality which takes a while for to get comfortable with
