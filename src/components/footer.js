...
const Footer = () => {
  ...
  `)
    ...
    return (
        ...
        >
            <a href={`https://twitter.com/${social.twitter}`} style={{ color: "transparent", boxShadow: "none" }}>
                <Image
            ...
            <a href={`https://github.com/${social.github}`} style={{ color: "transparent", boxShadow: "none" }}>
                <Image
